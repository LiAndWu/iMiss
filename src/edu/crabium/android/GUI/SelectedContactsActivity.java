...
public class SelectedContactsActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.selected_linkman);
        ...
        SelectContactsListView = (ListView) findViewById(R.id.selected_contact_listView); 
        SelectContactsListView.setOnItemClickListener(lis);
        
        final MyListAdapter mla = new MyListAdapter(SelectedContactsActivity.this, name.size(),
        		name.toArray(new String[][]{}));
        SelectContactsListView.setAdapter(mla);

        BackButton = (Button)findViewById(R.id.back_button);
        BackButton.setOnClickListener(new Button.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(SelectedContactsActivity.this, SetReplyActivity.class);
